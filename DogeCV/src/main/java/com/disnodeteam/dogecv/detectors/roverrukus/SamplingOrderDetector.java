...
public class SamplingOrderDetector extends DogeCVDetector {
    ...
    List<Rect>           chosenWhiteRect    = new ArrayList<Rect>(2);
    ...
    public Mat process(Mat input) {
        ...
        chosenWhiteRect.set(0, null);
        chosenWhiteRect.set(1, null);
    ...
    public Rect getChosenYellowRect() { return this.chosenYellowRect; }

    public Rect getChosenWhiteRect( int index ) {
        return this.chosenWhiteRect.get(index);
    }
}

...
public class GoldAlignDetector extends DogeCVDetector {
    ...
    private int  goldXPos = 0;     // X Position (in pixels) of the gold element
    private int  goldYPos = 0;
    ...
    public Mat process(Mat input) {
        ...
        if(bestRect != null){
            ...
            Imgproc.putText(displayMat, "Choosen", bestRect.tl(),0,1,new Scalar(255,255,255));

            // Set align X pos
            xPos = bestRect.x + (bestRect.width / 2);
            goldXPos = (int)xPos;
            goldYPos = (int)(bestRect.y + (bestRect.height / 2));
